...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h2>Breakfast</h2>
    <asp:Repeater ID="repeatBrowseMealBreakfast" runat="server">
        <ItemTemplate>
            <asp:Label ID="FoodNameLblBreakfast" runat="server" Text='<%# Eval("FullName") %>'></asp:Label>
            <asp:Image ID="FoodImageBreakfast" runat="server" />
        </ItemTemplate
    </asp:Repeater>

    <h2>Lunch</h2>
    <asp:Repeater ID="repeatBrowseMealLunch" runat="server">
        <ItemTemplate>
    ...
    <h2>Dinner</h2>
    <asp:Repeater ID="repeatBrowseMealDinner" runat="server">
        <ItemTemplate>
